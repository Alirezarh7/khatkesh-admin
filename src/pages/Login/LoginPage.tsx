...
export default function LoginPage() {
  const router = useLocation(); // در صورت نیاز به مسیریابی می‌توانید useNavigate را جایگزین کنید
  ...
  return (
    <div className="min-h-dvh w-full bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex items-center justify-center p-4" dir="rtl">
      <form
        onSubmit={handleSubmit(onSubmit)}
        className="w-full max-w-md"
        aria-label="فرم ورود"
      >
        <div className="backdrop-blur-xl bg-white/70 border border-white/60 shadow-2xl rounded-3xl p-6 md:p-8 space-y-6">
          {/* هدر */}
